...
const app = new app_1.default([new post_controller_1.default(), new order_controller_1.default(), new dashboard_controller_1.default(),
    new post_controller_1.default(), new order_controller_1.default(), new users_controller_1.default(), new comment_controller_1.default(), new register_controller_1.default(), new analytics_controller_1.default(), new analytics_controller_2.default(), new analytics_controller_3.default()], Number(PORT), MONGODB_URL);
app.listen();
