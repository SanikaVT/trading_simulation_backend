...
const app = new app_1.default([new post_controller_1.default(), new order_controller_1.default(), new users_controller_1.default(), new comment_controller_1.default()], Number(PORT), MONGODB_URL);
app.listen();
